    ...
    <footer className="bg-surface-container-lowest w-full py-12 border-t border-outline-variant/10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-gutter max-w-container-max mx-auto">
        <div className="space-y-4">
          <h2 className="font-headline-sm text-headline-sm text-onSurface">CyberVault Gaming</h2>
          ...
          <div className="flex gap-4">
            <a className="text-onSurfaceVariant hover:text-primary transition-colors" href="#">
        ...
        <div>
          ...
          <ul className="space-y-2 text-body-sm text-onSurfaceVariant">
            <li className="flex items-center gap-2">
              <span className="material-symbols-outlined text-xs">mail</span> soporte@cybervault.com
            </li>
            <li className="flex items-center gap-2">
              <span className="material-symbols-outlined text-xs">chat</span> WhatsApp: +54 9 11 1234-5678
            </li>
          </ul>
          <p className="mt-6 text-[10px] opacity-50">© 2024 CyberVault Gaming. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
